...
rcssci_linear<-function(data,y,x,covs,prob,filepath,...)
{
  rcs_linear.prob(data= data, y = y,x = x,covs=covs,prob=, filepath=filepath)
  rcs_linear.ushap(data= data, y = y,x = x,covs=covs,prob=, filepath=filepath)
  rcs_linear.nshap(data= data, y = y,x = x,covs=covs,prob=, filepath=filepath)
  rcs_linear.lshap(data= data, y = y,x = x,covs=covs,prob=, filepath=filepath)
}
